  ...
  data () {
    ...
    return {
      tasks: [
        ...
        {
          id: 9,
          label: 'Правки в меню, в каталоге, на странице потраченного времени',
          hours: 0.5
        },
        {
          id: 10,
          label: 'Hастройка логики сортировки товаров',
          hours: 0.5
        },
        {
          id: 11,
          label: 'Доработка валидации формы',
          hours: 0.5
        },
        {
          id: 12,
          label: 'Добавление анимации сортировки, сохранение данных в localStorage (чтоб товары сохранялись после перезагрузки страницы)',
          hours: 0.5
        },
        {
          id: 13,
          label: 'Добавление подгрузки товаров по скроллу',
          hours: 1
        }
      ]
    }
